%%writefile /mnt/prj-vol/tts-zipvoice-ft/egs/zipvoice/run_finetune1.sh
#!/bin/bash
...
model_dir=/mnt/models-vol/zipvoice
...
for subset in train test;do
      ...
      file_path=/mnt/data-vol/TTS-VIVOS/vivos_${subset}.tsv
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
      ...
      for subset in train test;do
            python3 -m zipvoice.bin.prepare_dataset \
                  --tsv-path /mnt/data-vol/TTS-VIVOS/vivos_${subset}.tsv \
                  --prefix custom-finetune \
                  --subset raw_${subset} \
                  --num-jobs ${nj} \
                  --output-dir  /mnt/data-vol/TTS-VIVOS/manifests
      done
...
if [ ${stage} -le 2 ] && [ ${stop_stage} -ge 2 ]; then
      ...
      for subset in train test;do
            python3 -m zipvoice.bin.prepare_tokens \
                  --input-file /mnt/data-vol/TTS-VIVOS/manifests/custom-finetune_cuts_raw_${subset}.jsonl.gz \
                  --output-file /mnt/data-vol/TTS-VIVOS/manifests/custom-finetune_cuts_${subset}.jsonl.gz \
                  --tokenizer ${tokenizer} \
                  --lang ${lang}
      done
...
if [ $stage -le 3 ] && [ $stop_stage -ge 3 ]; then
      ...
      for subset in train test; do
            python3 -m zipvoice.bin.compute_fbank \
                  --source-dir /mnt/data-vol/TTS-VIVOS/manifests \
                  --dest-dir /mnt/data-vol/TTS-VIVOS/fbank \
...
if [ ${stage} -le 5 ] && [ ${stop_stage} -ge 5 ]; then
      ...
      python3 -m zipvoice.bin.train_zipvoice \
            ...
            --feat-scale 0.1 \
            --max-len ${max_len} \
            --model-config ${model_dir}/zipvoice/model.json \
            --checkpoint ${model_dir}/zipvoice/iter-96000-avg-2.pt \
            --tokenizer ${tokenizer} \
            --lang ${lang} \
            --token-file ${model_dir}/zipvoice/tokens.txt \
            --dataset custom \
            --train-manifest /mnt/data-vol/TTS-VIVOS/fbank/custom-finetune_cuts_train.jsonl.gz \
            --dev-manifest /mnt/data-vol/TTS-VIVOS/fbank/custom-finetune_cuts_test.jsonl.gz \
            --exp-dir /mnt/data-vol/TTS-VIVOS/exp/zipvoice_finetune
...
if [ ${stage} -le 7 ] && [ ${stop_stage} -ge 7 ]; then
      ...
      python3 -m zipvoice.bin.infer_zipvoice \
            --model-name zipvoice \
            --model-dir /mnt/data-vol/TTS-VIVOS/exp/zipvoice_finetune \
